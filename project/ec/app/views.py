...
class ProductDetail(View):
    def get(self, request, pk):
        ...
        return render(request, "app/productdetail.html", {'product': product, 'wishlist': wishlist, 'totalitem': totalitem})
...
class CustomerRegistrationView(View):
    ...
    def post(self,request):
        ...
        if form.is_valid():
            form.save()
            messages.success(request,"Congratulation! User Registration Successesfully")
        else:
...
class ProfileView(View):
    ...
    def post(self,request):
            ...
            if form.is_valid():
                ...
                messages.success(request,"Congratulations! Profile was Successfully")
                reg.save()
...
def logout_view(request):
    logout(request)
    # Redirect to a page after logout, such as the home page
...
def plus_cart(request):
    if request.method == 'GET':
        ...
        try:
            ...
            # If multiple cart items exist, get the first one
...
def minus_cart(request):
    if request.method == 'GET':
        ...
        # decreament the quantity of the cart item
        cart_item.quantity -= 1
        cart_item.save()
...
def remove_cart(request):
    if request.method == 'GET':
        ...
        # remove  the quantity of the cart item
        cart_item.delete()
